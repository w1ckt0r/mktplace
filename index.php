...
<main>
                        ...
                        <div class="col-xl-6 col-lg-8">
                            ...
                            <form method="post" action="grid-listing-filterscol.html">
                                ...
                                <div class="search_trends">
                                    <h5>Principais buscas:</h5>
                                    <ul>
                                        <li><a href="#0">Software Farmacia</a></li>
                                        <li><a href="#0">PDV</a></li>
                                        <li><a href="#0">Meios de Pagamento</a></li>
                                        <li><a href="#0">Maquina de Cartão</a></li>
                                    </ul>
                                </div>
                            </form>
                        </div>
        ...
        <div class="container margin_30_60">
            <div class="main_title center">
                ...
                <p>Confira as principais soluções separadas por categorias</p>
            </div>
            <!-- /main_title -->
        ...
        <div class="bg_gray">
            <div class="container margin_60_40">
                <div class="main_title center">
                <span><em></em></span>
                <h2>Lista de empresas associadas</h2>
                <p>Confira os associados AFRAC e conheça seus produtos</p>
            </div>
                            ...
                            <ul>
                                <li>
                                    <a href="detail-restaurant.html">
                                        ...
                                        <h3>Segmentos</h3>
                                        <small>sobre seus proutos</small>
                                        <ul>
        ...
        <div class="container margin_30_60">
            <div class="main_title center">
                <span><em></em></span>
                <h2>Anunciantes</h2>
                <p>Confira nossos anunciantes do dia!</p>
            </div>
            <!-- /main_title -->
